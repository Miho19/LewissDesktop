...
export async function getLewissAluminiumTableEntryAsync(
  ...
  const control = getLewissAluminiumControl(spec)
  ...
  const spacerBlock = getLewissAluminiumSpacerBlock(spec)
...
export function getLewissAluminiumControl(spec: VenetianSpec) {
  return spec.operation
}

export function getLewissAluminiumSpacerBlock(spec: VenetianSpec) {
